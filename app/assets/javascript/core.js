(function(global, factory) {
    ...
    Checkboxes.prototype.setAttributes = function($input) {
        ...
        $content.classList.toggle('nhsuk-checkboxes__conditional--hidden', !inputIsChecked);
    };
    ...
    Header.prototype.handleClick = function(event) {
        ...
        if ($toggleButton && $target) {
            this.toggleClass($target, 'nhsuk-header__navigation--open');
            this.toggleClass($toggleButton, 'nhsuk-header__menu-button--open');
    ...
    Tabs.prototype.unhighlightTab = function($tab) {
        ...
        $tab.classList.remove('nhsuk-tabs__tab--selected');
        $tab.setAttribute('tabindex', '-1');
    };
    Tabs.prototype.highlightTab = function($tab) {
        $tab.setAttribute('aria-selected', 'true');
        $tab.classList.add('nhsuk-tabs__tab--selected');
        $tab.setAttribute('tabindex', '0');
    };
    Tabs.prototype.getCurrentTab = function() {
        return this.$module.querySelector('.nhsuk-tabs__tab--selected')
    };
